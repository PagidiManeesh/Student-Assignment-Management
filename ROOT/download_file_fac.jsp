...
<%
			   ...
			   ResultSet rs = st.executeQuery("select a.file_path,b.file_desc,a.sno,b.upload_date,b.username,b.faculty from assig_files_path a,assig_files_desc b,faculty_details c where b.faculty='" + c1 + "' and a.sno=b.sno and b.faculty=c.username order by b.upload_date desc");%>
