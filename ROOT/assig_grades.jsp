...
<%
			   ...
			   ResultSet rs = st.executeQuery("select a.file_path,b.file_desc,d.sno,b.upload_date,b.username,b.faculty,d.grade,d.result_date from assig_files_path a,assig_files_desc b,faculty_details c,stud_grades d where b.username='" + c1 + "' and a.sno=b.sno and a.sno=d.sno and b.faculty=c.username and a.username=d.stud_id and b.faculty=d.faculty order by d.result_date desc");%>
