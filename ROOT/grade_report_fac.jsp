...
<%
			   ...
			   ResultSet rs = st.executeQuery("select a.file_path,b.file_desc,d.sno,b.upload_date,b.username,b.faculty,d.grade,d.result_date from assig_files_path a,assig_files_desc b,faculty_details c,stud_grades d where b.faculty='" + c1 + "' and b.file_desc=d.assig_name and a.sno=b.sno and b.faculty=c.username and a.username=d.stud_id and b.faculty=d.faculty order by d.result_date desc");
			   %>

<table align="center" border="1">
<th>S.No.</th><th>File Desc.</th><th>File Upload Date</th><th>Uploaded By</th><th>To Faculty</th><th>Grade Obtained</th><th>Result Date</th><th>Delete</th>
<% 
int i=0;
while(rs.next())
{
...
<td>
<a href="del_grade.jsp?sno=<%=slno%>">Delete</a>
</td>
<%
