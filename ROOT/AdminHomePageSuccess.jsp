...
<tr>
          ...
          <tr>
			...
			out.println("Welcome  "+ (String)session.getAttribute("usrname")); %><br/><br/><br/><br/><img src="img2.jpg" width="500" height="299"></center>
			<br/><br/>
			<% response.setContentType("text/html"); 
			out.println("<center><font size='6' color='green'>Faculty Successfully Created</font></center>");
			 %></td>
      </tr>
        </table>
</body>
